    ...
    return (
        <Modal show={props.modalOpen}>
            ...
            </Modal.Header>
            {
                ...
                <div>
                    <Modal.Body>
                            <textarea onChange={handleTyping} placeholder='Type your message...' className='form-control' id='form-control'/>
                    </Modal.Body>
                    <Modal.Footer>
                        <button type="button" className="btn btn-primary" disabled={postContent == '' || postContent == undefined} onClick={submitPost}>Post</button>
                    </Modal.Footer>
                </div>
            }
        </Modal>
